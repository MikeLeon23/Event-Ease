...
public class AttendeeProfileUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendee_profile_update);

        edName = findViewById(R.id.edAttName);
        edEmail = findViewById(R.id.edAttEmail);
        edPhone = findViewById(R.id.edAttPhone);
        edPassword = findViewById(R.id.edAttPassword);
        ...
        attendeeId = getIntent().getStringExtra("COLUMN_ID"); // Assuming you pass attendeeId from previous activity
        ...
        btnGoBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AttendeeProfileUpdate.this, AttendeeAccountManage.class));
            }
        });
    }
