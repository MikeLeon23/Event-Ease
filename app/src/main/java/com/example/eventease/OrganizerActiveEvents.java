...
public class OrganizerActiveEvents extends AppCompatActivity {
    ...
    RecyclerView recyclerView = findViewById(R.id.recyclerViewOrgActive);
    private OrganizerListEventAdapter adapter;
    ...
    private void loadActiveEvents() {
        List<Event> activeEvents = dbHelper.getActiveEvents();
